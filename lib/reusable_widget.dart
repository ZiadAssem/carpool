...
Container resuableButton(
    BuildContext context, String title, width, Function() onTap) {
  return Container(
    width: width,
    height: 50,
    ...
    child: ElevatedButton(
      ...
      style: ButtonStyle(
          backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 142, 15, 6)),
...
PreferredSizeWidget reusableAppBar(title,TabBar){
  return AppBar(
        title: Text('$title'),
        backgroundColor:
